        ...
        */
        function activateNavDots(name, sectionIndex){
            if(options.navigation){
                ...
                if(name){
                    $(SECTION_NAV_SEL).find('a[href="#' + name + '"]').addClass(ACTIVE).trigger('activeChange');
                }else{
                    $(SECTION_NAV_SEL).find('li').eq(sectionIndex).find('a').addClass(ACTIVE).trigger('activeChange');
                }
            }
        }
